...
namespace Client2.ServiceReference1 {
    ...
    public interface IIssueTracker {
        ...
        int putIssue(Client2.ServiceReference1.Issue issue, string projectName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIssueTracker/putIssue", ReplyAction="http://tempuri.org/IIssueTracker/putIssueResponse")]
        System.Threading.Tasks.Task<int> putIssueAsync(Client2.ServiceReference1.Issue issue, string projectName);
        ...
        Client2.ServiceReference1.Issue getIssue(int id, string projectName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIssueTracker/getIssue", ReplyAction="http://tempuri.org/IIssueTracker/getIssueResponse")]
        System.Threading.Tasks.Task<Client2.ServiceReference1.Issue> getIssueAsync(int id, string projectName);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IIssueTrackerChannel : Client2.ServiceReference1.IIssueTracker, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IssueTrackerClient : System.ServiceModel.ClientBase<Client2.ServiceReference1.IIssueTracker>, Client2.ServiceReference1.IIssueTracker {
        ...
        public int putIssue(Client2.ServiceReference1.Issue issue, string projectName) {
            return base.Channel.putIssue(issue, projectName);
        }
        
        public System.Threading.Tasks.Task<int> putIssueAsync(Client2.ServiceReference1.Issue issue, string projectName) {
            return base.Channel.putIssueAsync(issue, projectName);
        }
        
        public Client2.ServiceReference1.Issue getIssue(int id, string projectName) {
            return base.Channel.getIssue(id, projectName);
        }
        
        public System.Threading.Tasks.Task<Client2.ServiceReference1.Issue> getIssueAsync(int id, string projectName) {
